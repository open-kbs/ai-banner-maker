...
import { OpenWith, Launch as Preview, CameraAlt as CaptureIcon } from '@mui/icons-material';
        ...
        <>
            ...
            {grapesjs && (
                <>
                    ...
                    <Tooltip title="Capture Editor View" placement={'top'}>
                        <IconButton
                            onClick={() => handleCaptureClick(editorRef, setBlockingLoading)}
                            aria-label="capture mode"
                            style={{ position: 'absolute', top: 38, left: 174, zIndex: 100, color: '#B9A5A6' }}
                        >
                            <CaptureIcon style={{ fontSize: 24 }} />
                        </IconButton>
                    </Tooltip>
                </>
            )}
